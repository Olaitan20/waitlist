...
export default function Services() {
  ...
  return (
    <section className="py-8 px-4 sm:py-10 md:py-14 lg:py-16">
      <div className="max-w-5xl sm:max-w-full md:max-w-4xl text-center px-4 sm:px-6 md:px-8 z-[999] mx-auto text-center">
        <div className="grid gap-4 sm:gap-6 md:gap-8 md:grid-cols-3">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-[#F5F1FF]  shadow-md p-4 sm:p-5 md:p-6 hover:shadow-xl transition-all duration-300"
            >
